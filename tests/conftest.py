...
@pytest.fixture
def mock_movebank_get_token_response():
    return b'{"api-token": "b227b987-20b1-4698-9b87-151abef9a445","api-token-expiry-date": "Wed Nov 20 09:51:09 CET 2024","login": "Gundi_test"}'
